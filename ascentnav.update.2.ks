...
set terminal:heigth to 5.
core:part:getmodule("kOSProcessor"):doevent("Open Terminal").

function score_launch {
        local fuel is 0.
        for resources in ship:resources {
        ...
        set total to total + ec_score * 5.s
...
function run_launch {
        ...
        // Ensure we get telemetry throughout the flight
